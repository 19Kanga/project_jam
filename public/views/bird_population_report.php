<?php
    ...
    // Fetch data using filters if available
    $filters = [
    ...
    $speciesData = $controller->getBirdsBySpecies($filters);
    $genderData = $controller->getBirdsByGender($filters);
?>
                ...
                <tbody>
                    <?php foreach ($speciesData as $species) { ?>
                        <tr>
                            ...
                            <td><?php echo $genderData[$species['species']]['male'] ?? 0; ?></td>
                            <td><?php echo $genderData[$species['species']]['female'] ?? 0; ?></td>
                            <td><?php echo $genderData[$species['species']]['unknown'] ?? 0; ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
